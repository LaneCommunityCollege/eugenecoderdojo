      ...
      {crmRegion name="event-page-eventinfo-actionlinks-top"}
        {if $allowRegistration}
          <div class="action-link section register_link-section register_link-top">
            <a href="{$registerURL}" title="{$registerText}" class="btn btn-info"><span>{$registerText}</span></a>
          </div>
        {/if}
        {if $session->get('userID') == 0}
          <div class="action-link section create_account_link-section create_account_link-top">
            <a href="/join" title="Create an account" class="btn btn-info"><span>Join the CoderDojo</span></a>
          </div>
        {/if}
      {/crmRegion}
    </div>
  ...
  {/if}
    ...
    <div class="crm-actionlinks-bottom">
      {crmRegion name="event-page-eventinfo-actionlinks-bottom"}
        ...
        {/if}
        {if $session->get('userID') == 0}
          <div class="action-link section create_account_link-section create_account_link-bottom">
              <a href="/join" title="Create an account" class="btn btn-info"><span>Join the CoderDojo</span></a>
          </div>
        {/if}
      {/crmRegion}
