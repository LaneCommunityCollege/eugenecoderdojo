...
/usr/bin/sudo /bin/bash $TRAVIS_BUILD_DIR/scripts/drupal-fix-perms.sh --drupal_path=$TRAVIS_BUILD_DIR/public_html --drupal_user=$dojouserid --httpd_group=$nobodyuid;
